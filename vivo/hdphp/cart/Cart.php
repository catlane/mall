    ...
    public function add( $data ) {
        ...
        foreach ( $data as $v ) {
            ...
            if ( isset( $goods[ $sid ] ) ) {
                ...
                $goods[ $sid ]['total'] = $goods[ $sid ]['num'] * $goods[ $sid ]['addAfterPirce'];
            } else {
                if ( $v['num'] == 0 ) {
                    continue;
                }
                $goods[ $sid ]          = $v;
                $goods[ $sid ]['total'] = $v['num'] * $v['addAfterPirce'];
            }
        }
        ...
        foreach ( $data as $dataOne ) {
            foreach ( $goods as $k => $v ) {
                if ( $k == $dataOne['sid'] ) {
                    ...
                    $goods[$k]['total']  = $dataOne['num'] * $v['addAfterPirce'];
