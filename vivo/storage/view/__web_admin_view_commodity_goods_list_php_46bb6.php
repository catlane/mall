...
<script type="text/javascript">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo u('commodity/index')?>">商品管理</a>
            </li>
            <li>
                货品管理
            </li>
                ...
                <div id="sample-table_wrapper" class="dataTables_wrapper no-footer">
                    <table class="table table-border table-bordered table-bg table-hover table-sort dataTable no-footer" id="sample-table" role="grid" aria-describedby="sample-table_info">
                        ...
                        <tr class="text-c" role="row">
                            ...
                            <th width="60" class="sorting_disabled" rowspan="1" colspan="1" aria-label="商品名称" style="width: 102px;">遍历出来</th>
                        ...
                        <?php foreach ((array)$data as $k=>$v){?>
                            <tr role="row" class="odd">
                                ...
                                <td class="sorting_1"><?php echo ($v['commodity_id'])?></td>
                                <td>
                                    <a href="<?php echo u('commodity/commodity_info',array('commodity_id'=>$v['commodity_id']))?>"><?php echo ($v['commodity_name'])?></a>
                                </td>
                                <td><?php echo $v['commodity_market_price']?></td>
                                <td><?php echo $v['commodity_mall_price']?></td>
                                <td><?php echo date('Y-m-d H:i:s',$v[commodity_added_time])?></td>
                                <td class="td-manage">
                                    <a title="货品列表" href="<?php echo u('commodity/goods_list',array('commodity_id'=>$v['commodity_id']))?>" class="btn btn-xs btn-primary"><i class="icon-list bigger-120"></i></a>
                                    <a title="编辑" onclick="member_edit('编辑','<?php echo u('commodity/edit',array('commodity_id'=>$v['commodity_id']))?>','<?php echo ($v['commodity_id'])?>','','510')" href="javascript:;" class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>
                                    <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $v['commodity_id']?>')" class="btn btn-xs btn-warning"><i class="icon-trash  bigger-120"></i></a>
                                </td>
                            </tr>
                        <?php }?>
                        <tr role="row" class="odd">
                            ...
                            <td>17381239</td>
                            <td class="td-manage">
                                <a title="货品列表" href="<?php echo u('commodity/goods_list',array('commodity_id'=>$v['commodity_id']))?>" class="btn btn-xs btn-primary" style="width: 100%"><i class="icon-plus bigger-120" style="width: 100%"></i></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <script>
            ...
            function member_del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                    $.post("<?php echo u('commodity/del')?>",{'commodity_id':id},function(){
                    },'json')
