...
<script type="text/javascript">
	...
	<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
	<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/jquery.ui.touch-punch.min.js"></script>
					...
					<form action="" method="post" class="form">
						<div id="home" class="tab-pane active">
							<div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>底部版权信息： </label>
								<div class="col-sm-9"><input type="text" name="sys_copy" value="<?php echo $data['sys_copy']?>" id="website-title" placeholder="" value="" class="col-xs-10 "></div>
							</div>
							<div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>备案号： </label>
								<div class="col-sm-9"><input type="text" name="sys_beian" value="<?php echo $data['sys_beian']?>" id="website-title" placeholder="" value="" class="col-xs-10 "></div>
							</div>
							<div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>统计代码： </label>
								<div class="col-sm-9"><textarea name="sys_count" class="textarea" style="border: 1px solid #d5d5d5;"><?php echo $data['sys_count']?></textarea></div>
							</div>
							<div class="Button_operation">
								<button class="btn btn-primary radius" type="submit"><i class="fa fa-save "></i>&nbsp;保存</button>
								<button onclick="layer_close();" class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
								<input type="hidden" name="sys_id" value="<?php echo $data['sys_id']?>">
							</div>
						</div>
					<input type='hidden' name='__TOKEN__' value='7853fcbce5b1ed48f1defba0968db480'/></form>
				</div>
			</div>
		</div>
	...
	<script>
		$(function(){
			...
			$('.form').submit(function(){
				...
				$.post("<?php echo u('systemSetting/edit')?>",data,function (res) {
					if(res.valid){
						layer.alert("修改成功");
					}else{
		...
		<script>
			$(function () {
				...
				$.each($("#nav_list li").find("ul.submenu").find("li a"),function () {
					if("系统管理"){
						if($(this).parent("li").parent("ul").siblings("a").find("span").html().indexOf("系统管理") > -1){
