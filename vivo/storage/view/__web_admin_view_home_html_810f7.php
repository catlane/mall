    ...
    <!--***************************************************************************-->
        ...
        <div class="page-content clearfix">
            <div class="alert alert-block alert-success" style="text-align: left;">
                ...
                <i class="icon-ok green"></i>欢迎使用<strong class="green">后台管理系统<small>(v1.2)</small></strong>,您本次登陆时间为<?php echo date('Y年m月d日 H:i:s',$thisLogin['loginLog_time'])?>，登陆IP:<?php echo $thisLogin['loginLog_IP']?>
            </div>
            <div class="state-overview clearfix">
                ...
                <div class="col-sm-6">
                    <section class="panel">
                        ...
                        <div class="value">
                            <h1>￥<?php echo number_format($orderFormPrice,2)?></h1>
                            <p>交易记录</p>
                        </div>
                    </section>
                </div>
