    ...
    <div class="clearfix">
        <div class="admin_info_style">
            <div class="border clearfix">
               <span class="l_f">
                    <a href="<?php echo u('type/add')?>" title="添加类型" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加类型</a>
               </span>
                <span class="r_f">共：<b><?php echo count($data)?></b>个类型</span>
            </div>
                        ...
                        <tbody>
                            <?php foreach ((array)$data as $k=>$v){?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class="sorting_1"><?php echo ($v['type_id'])?></td>
                                    <td>
                                        <a href="<?php echo u('type/type_info',array('type_id'=>$v['type_id']))?>"><?php echo ($v['type_name'])?></a>
                                    </td>
                                    <td class="td-manage">
                                        <a title="添加类型属性" onclick="member_edit('添加类型属性','<?php echo u('type/addAttr',array('type_id'=>$v['type_id']))?>','<?php echo ($v['type_id'])?>','','510')" href="javascript:;" class="btn btn-xs btn-success"><i class="icon-edit bigger-120"></i></a>
                                        <a title="编辑" onclick="member_edit('编辑','<?php echo u('type/edit',array('type_id'=>$v['type_id']))?>','<?php echo ($v['type_id'])?>','','510')" href="javascript:;" class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>
                                        <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $v['type_id']?>')" class="btn btn-xs btn-warning"><i class="icon-trash  bigger-120"></i></a>
                                    </td>
                                </tr>
                            <?php }?>
                        </tbody>
...
<script>
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.post("<?php echo u('type/del')?>",{'type_id':id},function(){
            },'json')
