...
<head>
    ...
    <link href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/font-awesome.min.css" />
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/font-awesome-ie7.min.css" />
    <![endif]-->
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/ace.min.css" />
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/ace-rtl.min.css" />
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/ace-skins.min.css" />
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/css/style.css"/>
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="<?php echo __ROOT__?>/resource/hdjs/admin/assets/css/ace-ie.min.css" />
    <![endif]-->
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/ace-extra.min.js"></script>
    <!--[if lt IE 9]>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/html5shiv.js"></script>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/respond.min.js"></script>
    <![endif]-->
    <!--[if !IE]> -->
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/js/jquery-1.9.1.min.js"></script>
    <!-- <![endif]-->
    <!--[if IE]>
    ...
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/bootstrap.min.js"></script>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/typeahead-bs2.min.js"></script>
    <!--[if lte IE 8]>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/excanvas.min.js"></script>
    <![endif]-->
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/ace-elements.min.js"></script>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/js/ace.min.js"></script>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/layer/layer.js" type="text/javascript"></script>
    <script src="<?php echo __ROOT__?>/resource/hdjs/admin/assets/laydate/laydate.js" type="text/javascript"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <img src="<?php echo __ROOT__?>/resource/hdjs/admin/images/logo.png">
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
