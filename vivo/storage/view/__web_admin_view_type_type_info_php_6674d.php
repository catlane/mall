        ...
        <div class="brand_info clearfix">
            <div class="title_brand">类型信息</div>
                <ul class="Info_style clearfix" style="margin-right: 0;">
                    <li style="width: 100%;"><label class="label_name">类型名称：</label> <span class="name"><?php echo $type_name?></span></li>
                                ...
                                <div style="float: left;width: auto;border-top: 1px solid #ccc;" class="type_attr">
                                            <div class="b_Introduce" style="clear: left;">
                                                <label class="label_name"  style="float: left;width: 80px;line-height: 40px;text-align: right;">类型
                                                    <?php if($value['type_attr_type'] == 1){?>
                
                                                        <span style="color: #999;">规格</span>
                                                    
               <?php }?>
                                                    <?php if($value['type_attr_type'] == 0){?>
               ...
               <?php }?>
                                            ...
                                            <div class="b_Introduce" style="clear: left;">
                                                ...
                                                <label class="label_name"  style="float: left;width: 80px;line-height: 40px;text-align: right;"><?php echo $value['type_attr_name']?>:</label>
                                                <p class="name" style="float: left;line-height: 40px;margin-left: 5px;"><?php echo $value['type_attr_value']?></p>
                                                <div class="td-manage" style="float: left;margin-left: 20px">
                                                    <a title="编辑" onclick="member_edit('编辑','<?php echo u('type/editAttr',array('type_attr_id'=>$value['type_attr_id']))?>','4','','510')" href="javascript:;" class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>
                                                    <a title="删除" href="javascript:;" onclick="type_attr_del(this,'<?php echo $value['type_attr_id']?>')" class="btn btn-xs btn-warning"><i class="icon-trash  bigger-120"></i></a>
                                                </div>
                                            </div>
                                        </div>
                            <?php }?>
