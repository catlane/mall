								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="login_icon"><img src="<?php echo __ROOT__?>/web/admin/view/images/login.png" /></div>
											...
											<input type='hidden' name='__TOKEN__' value='a3380c5c563394adf5cace301faae9f5'/></form>
...
$('#login_btn').on('click', function(){
     ...
     $("input[type$='text']").each(function(n){
		  ...
		  if(num>0){  return false;}	 	
			  ...
			  //这里提交异步，判断是否提交成功
			  $.post('<?php echo u("login/index")?>',data,function (res) {
				  if(res.valid){
