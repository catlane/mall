  ...
  <div class="brand_info clearfix">
   ...
   <form>
    <ul class="Info_style clearfix">
     <li><label class="label_name">品牌名称：</label> <span class="name"><?php echo $data['brands_name']?></span></li>
      <li><label class="label_name">排序：</label><span class="name"><?php echo $data['brands_sort']?></span></li>
    ...
    <div class="brand_logo">
      <img src="<?php echo $data['brands_logo']?>"  width="120px" height="60px"/>
      <p class="name"><?php echo $data['brands_name']?></p>
    </div>
   <input type='hidden' name='__TOKEN__' value='67c4c656523ec6e884056ffe4f2e474c'/></form>
   </div>
 </div>
 <!--品牌商品-->
 <div class="border clearfix">
       <span class="l_f">
        <a href="<?php echo u('commodity/add')?>"  title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
       </span>
       <span class="r_f">该品牌下共：<b><?php echo $count?></b>件商品</span>
  </div>
     <!--产品列表-->
