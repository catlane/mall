...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
		...
		<link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo1/vivo/resource/hdjs/home/css/master.css" />
					<link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo1/vivo/resource/hdjs/home/css/success.css" />
        ...
        <div id="content" class="cl">
            ...
            <div id="content" class="cl">
                    ...
                    <div class="page-box">
                        <dl class="cl">
                            ...
                            <dd class="content-container">
                                <h3 class="title">订单提交成功，订单金额<span class="red bold"><?php echo number_format($data["orderForm_price"],2)?></span>元。</h3>
                                <input id="order-no" type="hidden" value="16101483195542320292">

                                <p class="comment">订单号<?php echo $data['orderForm_num']?>，可进入“<a href="<?php echo u('my/order')?>">我的订单</a>”实时查询您的订单及跟踪物流信息。
                                </p>
               ...
               <?php }?>
                                ...
                                <p class="order-address">配送：<?php echo $data['orderForm_address']?> /<?php echo $data['orderForm_taxType']?> </p>

                                <p class="pay-type">支付方式：<?php echo $data["orderForm_payMethod"]?></p>
                            </dd>
                        </dl>
                    </div>
                    <div class="btns">
                        <button type="button" class="btn-cancel" onclick="location.href='<?php echo u("index/index")?>'">再去逛逛</button>
                        <button class="btn-confirm" type="button" onclick="location.href='<?php echo u("my/order")?>'">查看我的订单</button>
                    </div>
                </div>
                <!--content end -->
            </div>
