...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo/resource/hdjs/home/css/master.css"/>
            ...
            <link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo/resource/hdjs/home/css/my_allRemark.css"/>
...
<div class="head-search">
    <div class="search-box">
        ...
        <input type='hidden' name='__TOKEN__' value='c6c367be8a91193704d4059ddc485b3a'/><input type='hidden' name='__TOKEN__' value='c6c367be8a91193704d4059ddc485b3a'/><input type='hidden' name='__TOKEN__' value='c6c367be8a91193704d4059ddc485b3a'/></form>
...
<header class="header">
    <div class="wrapper">
        <nav>
            ...
            <ul class="nav">
                <li><a href="http://127.0.0.1/vivo/index.php?s=home/product/phone">手机</a></li>
                <li><a href="#">配件</a></li>
                <li><a href="#">V币商品</a></li>
                <li><a href="#">服务</a></li>
                <li><a href="#">社区</a></li>
    ...
    <div class="main">
        <div class="content">
            <div class="crumbs">
                ...
                <b></b>
                <a href="<?php echo u('my/index')?>">会员中心</a><b></b>我的评论            </div>
        </div>
        <div class="content">
