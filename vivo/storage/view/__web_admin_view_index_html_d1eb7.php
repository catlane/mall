...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo __ROOT__?>/web/admin/view/assets/css/css/font-awesome.min.css" />
		<!--[if IE 7]>
		  <link rel="stylesheet" href="<?php echo __ROOT__?>/web/admin/view/assets/css/css/font-awesome-ie7.min.css" />
		<![endif]-->
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  ...
	  location.href="<?php echo u('login/quit')?>";
    });
});
})
</script>
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>					
						<img src="<?php echo __ROOT__?>/web/admin/view/images/logo.png">
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
               ...
               <ul class="nav ace-nav">	
                <li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<?php if($admin_user_username == ''){?>
                
									管理员
								<?php }else{?>
									<?php echo $admin_user_username?>
               ...
               <?php }?>
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li><a href="<?php echo u('admininfo/index')?>"><i class="icon-user"></i>个人资料</a></li>
								<li class="divider"></li>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="<?php echo u('index/index')?>" name="" class="iframeurl" title=""><i class="icon-dashboard"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 <li class="home"><a  href="<?php echo u('brands/index')?>" name="Brand_Manage.html" title="品牌管理"  class="iframeurl"><i class="icon-double-angle-right"></i>品牌管理</a></li>
						 <li class="home"><a href="<?php echo u('category/index')?>" name="<?php echo u('category/index')?>" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
						 <li class="home"><a href="<?php echo u('type/index')?>" name="<?php echo u('type/index')?>" title="类型管理"  class="iframeurl"><i class="icon-double-angle-right"></i>类型管理</a></li>
						   <li class="home"><a href="<?php echo u('commodity/index')?>" name="<?php echo u('commodity/index')?>" title="商品管理"  class="iframeurl"><i class="icon-double-angle-right"></i>商品管理</a></li>
						</ul>
					</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 图片管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
						<li class="home"><a href="<?php echo u('Advertising/index')?>" name="advertising.html" title="广告管理" class="iframeurl"><i class="icon-double-angle-right"></i>广告管理</a></li>
							</ul>
						</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 交易管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                    <li class="home"><a href="<?php echo u('transaction/index')?>" name=".html" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                    <li class="home"><a href="<?php echo u('orderform/index')?>" name="" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
					<li class="home"><a href="<?php echo u('returns/index')?>" name="" title="退/换货管理"  class="iframeurl"><i class="icon-double-angle-right"></i>退/换货管理</a></li>
                   </ul>
				  </li>
                  <!--<li>-->
				  ...
				  <!--</li>-->
						...
						<!--</li>-->
							...
							<ul class="submenu">
								<li class="home"><a href="<?php echo u('systemSetting/index')?>" name="" title="系统设置" class="iframeurl"><i class="icon-double-angle-right"></i>系统设置</a></li>
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="<?php echo u('Administrator/index')?>" name="administrator.html" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
								  <li class="home"><a href="<?php echo u('admininfo/index')?>" name="admin_info.html" title="个人信息" class="iframeurl"><i class="icon-double-angle-right"></i>个人信息</a></li>
							</ul>
						</li>
					</ul>
                ...
                <script type="text/javascript">
                 ...
                 <!--<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="<?php echo __ROOT__?>/web/admin/view/home.html">  </iframe>-->
		...
		<script>
			$(function () {
				...
				$.each($("#nav_list li").find("ul.submenu").find("li a"),function () {
					if("<?php echo $on?>"){
						if($(this).parent("li").parent("ul").siblings("a").find("span").html().indexOf("<?php echo $on?>") > -1){
