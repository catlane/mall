...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
		...
		<link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo1/vivo/resource/hdjs/home/css/master.css" />
					...
					<link rel="stylesheet" type="text/css" href="http://127.0.0.1/vivo1/vivo/resource/hdjs/home/css/transportCost.css" />
	...
	<body>
		<div class="head-search">
			<div class="search-box">
				...
				<input type='hidden' name='__TOKEN__' value='be0b3c3628d28ea2db2471dafa53c05f'/><input type='hidden' name='__TOKEN__' value='be0b3c3628d28ea2db2471dafa53c05f'/></form>
				<script>
					$(function() {
		...
		<div class="content">
			<aside class="menu-bar">
				<dl class="menu">
					...
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/alipay')?>">支付宝支付</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/huabei')?>">花呗分期</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/invoice')?>">发票说明</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/coupon')?>">优惠券说明</a>
					</dd>
					<dt class="menu-title send-mode"><i></i><span>配送方式</span></dt>
					<dd class="menu-item on">
						<a href="<?php echo u('helpcenter/transport')?>">配送方式</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/transportCost')?>">配送费用</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/sign')?>">签收须知</a>
					</dd>
					<dt class="menu-title service-support"><i></i><span>服务支持</span></dt>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/servicePromise')?>">服务保证</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/afterService')?>">售后服务</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/brokenScreen')?>">碎屏宝</a>
					</dd>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/extendService')?>">手机延保</a>
					</dd>
					<dt class="menu-title brand-service"><i></i><span>品牌服务</span></dt>
					<dd class="menu-item">
						<a href="<?php echo u('helpcenter/contactUs')?>">联系我们</a>
					</dd>
				</dl>
			</aside>
			<!--blade_right-->
