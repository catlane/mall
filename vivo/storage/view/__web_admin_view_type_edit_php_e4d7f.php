...
<div class="member_show" >
    <form action="">
        <div class="form-group has-success">
            ...
            <input type="text" class="form-control" id="type_name" name="type_name" value="<?php echo $oldData['type_name']?>">
        </div>
    ...
    <input type='hidden' name='__TOKEN__' value='ff07f9d8ad97a26b43142b9cd05418e2'/></form>

</div>
<script>
    $('.submit').click(function(){
        var data = $(this).parents('form').serialize();
        $.post("<?php echo u('type/edit')?>",data,function (res) {
            if(res.valid){
                layer.alert(res.message,{
                    ...
                    time:3000,
                    yes:function () {
                        parent.location.href = "<?php echo u('type/index')?>";
                    },
                });
                setTimeout(function () {
                    parent.location.href = "<?php echo u('type/index')?>";
