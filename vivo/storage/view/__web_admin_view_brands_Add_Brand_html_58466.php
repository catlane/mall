...
<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li class="active">
			<a class="Current_page iframeurl" href="<?php echo u('brands/index')?>" style="color: rgb(76, 143, 189); cursor: pointer;">品牌管理</a>
		</li>
		<li class="active" id="parentIframe" style="display: inline-block;"><span class="parentIframe iframeurl">添加品牌</span></li>
...
<div class=" clearfix">
 ...
 <div class="left_add" style="width: 100%;">
   <div class="title_name" style="width: 100%">添加品牌</div>
         ...
         <ul class="add_conent">
             <li class=" clearfix"><label class="label_name"><i>*</i>品牌名称：</label> <input name="brands_name" type="text" class="add_text"/></li>
             <li class=" clearfix"><label class="label_name"><i>*</i>品牌排序：</label> <input name="brands_sort" type="number" minlength="1" class="add_text" style="width:80px"/></li>
             <li class=" clearfix"><label class="label_name">品牌图片：</label>
                 <div class="demo l_f">
                     ...
                     <div class="logoupload">
						 <input type="hidden" name="brands_logo" value="" class="brands_logo">
             ...
             <li class=" clearfix"><label class="label_name"><i>*</i>是否热门：</label>
				 <!--<input name="" type="text" class="add_text" style="width:120px"/>-->
				 <select name="brands_ifhot" style="width: 120px">
  ...
  <div class="button_brand" style="bottom: 30px;position: fixed;">
	  ...
	  <input name="" type="reset" value="清空" class="btn btn-warning"/>
  </div>
</div>
<input type='hidden' name='__TOKEN__' value='b3d43ddbc5232552c627ec43e1213411'/></form>
</body>
</html>
<script type="text/javascript">
...
function successAction(fileInfo) {
	...
	$(".logobox .resizebox > img").attr('src', "<?php echo __ROOT__?>/web/admin/view/" + up_path);
	$(".logobox .resizebox > img").attr('width', _up_width);
	$(".logobox .resizebox > img").attr('height', _up_height);
	$(".brands_logo").val("<?php echo __ROOT__?>/web/admin/view/" + up_path);
}
...
$(document).ready(function() {
	...
	<script>
		...
		$('.btn-save').click(function () {
			...
			$.post("<?php echo u('brands/addBrand')?>",data,function (res) {
				if(res.valid){
					layer.alert('添加成功',{
						title: '提示框',
						icon:1,
						yes:function () {
							location.href = "<?php echo u('brands/index')?>";
						}
					});
					layer.close();
					return true;
