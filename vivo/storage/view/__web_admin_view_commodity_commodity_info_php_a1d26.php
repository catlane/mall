        ...
        <div class="brand_detailed" id="box">
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix">
                    <li><label class="label_name">商品名称：</label> <span class="name"><?php echo $commodity_data['commodity_name']?></span></li>
                    <li><label class="label_name">商品货号：</label><span class="name"><?php echo $commodity_data['commodity_num']?></span></li>
                    <li><label class="label_name">商品货号：</label><span class="name"><?php echo $commodity_data['commodity_num']?></span></li>
                    <li><label class="label_name">商品单位：</label><span class="name"><?php echo $commodity_data['commodity_unit']?></span></li>
                    <li><label class="label_name">市场价：</label><span class="name"><?php echo $commodity_data['commodity_market_price']?></span></li>
                    <li><label class="label_name">商城价：</label><span class="name"><?php echo $commodity_data['commodity_mall_price']?></span></li>
                    <li><label class="label_name">总库存：</label><span class="name"><?php echo $commodity_data['commodity_all_stock']?></span></li>
                    <li><label class="label_name">点击量：</label><span class="name"><?php echo $commodity_data['commodity_click']?></span></li>
                    <li><label class="label_name">上架时间：</label><span class="name"><?php echo date('Y-m-d H:i:m',$commodity_data['commodity_added_time'])?></span></li>
                    <li><label class="label_name">所属分类：</label><span class="name"><?php echo $commodity_data['category_name']?></span></li>
                    <li><label class="label_name">所属类型：</label><span class="name"><?php echo $commodity_data['type_id']?></span></li>
                    <li><label class="label_name">所属品牌：</label><span class="name"><?php echo $commodity_data['brands_name']?></span></li>
                    <li><label class="label_name">管理员：</label><span class="name"><?php echo $commodity_data['admin_name']?></span></li>
                </ul>
                <div class="brand_logo">
                    <img src="<?php echo $commodity_data['commodity_list_img']?>"  width="140px" height="140px"/>
                    <p class="name"><?php echo $commodity_data['commodity_name']?></p>
                </div>
            </div>
            <!--这是商品属性-->
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix">
                    <li><label class="label_name">商品属性：</label>
                        <?php foreach ((array)$commodity_data['attr'] as $key=>$value){?>
                            <span class="name" style="background: #FFE4E1;border-radius: 10px;margin: 3px;padding: 5px;"><?php echo $value?></span>
                        <?php }?>
                    </li>
                </ul>
            </div>
            ...
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix">
                    <?php foreach ((array)$commodity_data['spec'][value] as $key=>$value){?>
                    <li style="width: 100%">
                        <label class="label_name"><?php echo $commodity_data['spec']['name'][$key]?>：</label>
                        <span class="name"><?php echo $value?>：&nbsp;&nbsp;<b style="color:red;"><?php echo $commodity_data['spec']['addprice'][$key]?></b>&nbsp;元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    </li>
                    <?php }?>
                </ul>
            </div>
            ...
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix">
                    <li style="width: 100%;height: auto;">
                        ...
                        <?php foreach ((array)$commodity_data['many_image'] as $key=>$value){?>
                            <span class="name" style="float: left;">
                                <div style="padding: 5px;border-radius: 5px;border: 1px solid #ccc;">
                                    <img src="<?php echo $value?>" alt="" style="padding-bottom: 0px;width: 200px;">
                                </div>
                            </span>
                        <?php }?>
                    </li>
            ...
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix" style="margin-right: 0">
                    <li style="width: 100%;max-height: 500px;overflow: scroll;padding-left: 15px;">
                        <?php echo $commodity_data['about_commodity_about']?>
                    </li>
                </ul>
            </div>
            <!--这是商品售后服务-->
            <div class="brand_info clearfix">
                ...
                <ul class="Info_style clearfix" style="margin-right: 0">
                    <li style="width: 100%;max-height: 500px;overflow: scroll;padding-left: 15px;">
                        <?php echo $commodity_data['about_commodity_afterMarket']?>
                    </li>
                </ul>
            </div>
        </div>
