...
<!---->
 <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO  src="<?php echo __ROOT__?>/web/admin/view/product-category-add.html" class="page_right_style"></iframe>
 </div>
</div>
<!--**********************************************************-->
<script type="text/javascript">
