		...
		<link rel="stylesheet" href="<?php echo __ROOT__?>/web/admin/view/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="<?php echo __ROOT__?>/web/admin/view/assets/css/ace-skins.min.css" />
		...
		<![endif]-->
		<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/html5shiv.js"></script>
		<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/respond.min.js"></script>
		<![endif]-->
        <!--[if !IE]> -->
		...
		<!--[if lte IE 8]>
		  <script src="<?php echo __ROOT__?>/web/admin/view/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/ace-elements.min.js"></script>
		<script src="<?php echo __ROOT__?>/web/admin/view/assets/js/ace.min.js"></script>
    ...
    <div class="clearfix" id="add_picture" style="width: 100%;">
        <div class="page_right_style" style="width: 100%">
            <form action="script:;" method="post" class="form form-horizontal" id="form-article-add">
            	<input type="hidden" name="type_id" value="<?php echo $oldData['type_id']?>" />
                <div class="clearfix cl">
                    <label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $oldData['commodity_name']?>" placeholder="" id="" name="commodity_name"></div>
                </div>
                <div class=" clearfix cl">
                    <label class="form-label col-2">商品标题：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $oldData['commodity_title']?>" placeholder="" id="" name="commodity_title"></div>
                </div>
                <div class=" clearfix cl">
                    <label class="form-label col-2">商品货号：</label>
                    <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $oldData['commodity_num']?>" placeholder="" id="" name="commodity_num"></div>
                </div>
                ...
                <div class=" clearfix cl">
                    <div class="Add_p_s">
                        ...
                        <div class="formControls col-2">
                            <input type="text" class="input-text" value="<?php echo $oldData['commodity_unit']?>" placeholder="商品单位" id="" name="commodity_unit">
                        </div>
                    </div>

                    <div class="Add_p_s">
                        <label class="form-label col-2">市场价格：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="<?php echo $oldData['commodity_market_price']?>" placeholder="市场价格" id="" name="commodity_market_price" >元</div>
                    </div>

                    <div class="Add_p_s">
                        <label class="form-label col-2">商城价格：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" value="<?php echo $oldData['commodity_mall_price']?>" placeholder="商城价格" id="" name="commodity_mall_price" >元</div>
                    </div>

                    <div class="Add_p_s">
                        <label class="form-label col-2">总库存：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" placeholder="总库存" id="" name="commodity_all_stock" value="<?php echo $oldData['commodity_all_stock']?>" ></div>
                    </div>

                    <div class="Add_p_s">
                        <label class="form-label col-2">点击率：</label>
                        <div class="formControls col-2"><input type="text" class="input-text" placeholder="点击率" id="" name="commodity_click" value="<?php echo $oldData['commodity_click']?>"></div>
                    </div>
                            ...
                            <span class="select-box">
                                <select class="select" name="brands_brands_id">
                                    ...
                                    <?php foreach ((array)$brandData as $key=>$value){?>
                                        <option value="<?php echo $value['brands_id']?>" <?php if($oldData['brands_brands_id'] == $value['brands_id']){?>
                selected
               <?php }?> ><?php echo $value['brands_name']?></option>
                                    <?php }?>
                                </select>
				            </span>
                        </div>
                            ...
                            <span class="select-box">
                                <select class="select category" name="category_id">
                                    ...
                                    <?php foreach ((array)$cateData as $key=>$value){?>
                                        <option value="<?php echo $value['category_id']?>" category_pid = "<?php echo $value['category_pid']?>" <?php if($oldData['category_id'] == $value['category_id']){?>
                selected
               <?php }?> ><?php echo $value['_category_name']?></option>
                                    <?php }?>
                                </select>
				            </span>
                        </div>
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10" id="attr">
                        <table class="table table-hover">
                            <tbody>
                                <?php foreach ((array)$oldData['attr'] as $key=>$value){?>
                                    <tr>
                                        <td><?php echo $value['type_attr_name']?></td>
                                        <td>
                                            <select name="attr[<?php echo $value['type_attr_type_attr_id']?>]">
                                            	<option value="0">请选择</option>
                                                <?php foreach ((array)$value['type_attr_value'] as $k=>$v){?>
                                                    <option value="<?php echo $v?>" <?php if($value['commodity_attr_value'] == $v){?>
                selected
               <?php }?> ><?php echo $v?></option>
                                                <?php }?>
                                            </select>
                                        </td>
                                    </tr>
...
<!--                这是商品规格-->
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10" id="norm">
                        <table class="table table-hover">
                            <tbody>
                                <?php foreach ((array)$oldData['spec'] as $key=>$value){?>
                                    <tr>
                                        <td><?php echo $value['type_attr_name']?></td>
                                        <td>
                                            <select name="spec[<?php echo $value['type_attr_type_attr_id']?>][value][]">
                                                <?php foreach ((array)$value['type_attr_value'] as $k=>$v){?>
                                                    <option value="<?php echo $v?>" <?php if($value['commodity_attr_value'] == $v){?>
                selected
               <?php }?> ><?php echo $v?></option>
                                        ...
                                        <td>
                                            <input name="spec[<?php echo $value['type_attr_type_attr_id']?>][addPrice][]" value="<?php echo $value['commodity_attr_addprice']?>" placeholder="请输入附加价格">
                                        </td>
                                        <td>
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10" style="position: relative">
                            <input type="text" class="form-control" style="margin-left: 0;width: 70%;float: left;" id="commodity_list_img" name="commodity_list_img" readonly="" value="<?php echo $oldData['commodity_list_img']?>" style="padding: 0 10px">
                ...
                <div class="clearfix cl ">
                    <label class="form-label col-2">图片展示：</label>
                        <div class="input-group listImg" style="margin-top:5px;margin-left: 10px;float: left;">
                            <img src="<?php echo $oldData['commodity_list_img']?>" class="img-responsive img-thumbnail" width="150">
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10" style="position: relative">
                        <input type="text" class="form-control" style="margin-left: 0;width: 70%;float: left;" id="many_image" name="many_image" readonly="" value="<?php echo $oldData['about_commodity_big_album']?>" style="padding: 0 10px">
                        <div style="position: absolute;right: 10%;">
                            <div id="queue"></div>
                ...
                <div class="clearfix cl" >
                    <label class="form-label col-2">图片展示：</label>
                    <div class="manyImg">
                        <?php foreach ((array)$oldData['many_image'] as $key=>$value){?>
                           <?php if($value){ ?>
                               <div class="input-group" style="margin-top:5px;margin-left: 10px;float: left;">
                                   <img src="<?php echo $value?>" class="img-responsive img-thumbnail many_img" width="150">
                ...
                <div class="clearfix cl">
                    ...
                    <div class="formControls col-10">
                        <script id="about_commodity_about" name="about_commodity_about" type="text/plain" style="width:100%;height:400px;"><?php echo $oldData['about_commodity_about']?></script>
                    </div>
                </div>
                <div class="clearfix cl" style="overflow: scroll;">
                    <label class="form-label col-2">售后服务：</label>
                    <div class="formControls col-10">
                        <script id="about_commodity_afterMarket" name="about_commodity_afterMarket" type="text/plain" style="width:100%;height:400px;"><?php echo $oldData['about_commodity_afterMarket']?></script>
                    </div>
                </div>
                <div class="clearfix cl">
                ...
                <input type="hidden" name="commodity_id" value="<?php echo $oldData['commodity_id']?>">
                <input type="hidden" name="about_commodity_id" value="<?php echo $oldData['about_commodity_id']?>">
...
//        这是当我点击分类的时候，然后我异步变化他所对应的类型属性以及规格
        $('.category').change(function () {
            ...
            if(category_id == <?php echo $oldData['category_id']?>){
...
//            'uploadLimit' : 10,//文件上传数量
        ...
        function removeImgOnce(obj) {
            ...
            $.post("<?php echo u('commodity/editDelImg')?>",{'src':src},function () {
            },'json')
...
<!--    这是表单提交,ajax异步提交-->
    <script>
      $('.submit').click(function () {
          ...
          $.post("<?php echo u('commodity/edit')?>",data,function (res) {
              if(res.valid){
                  layer.alert('修改成功',{
                      title:'提示框',
                      icon:1,
                      yes:function () {
                          parent.location.href = "<?php echo u('commodity/index')?>";
                      }
