...
<script type="text/javascript">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">
                <a class="Current_page iframeurl" href="<?php echo u('type/index')?>" style="color: rgb(76, 143, 189); cursor: pointer;">类型管理</a>
            </li>
    ...
    <input type='hidden' name='__TOKEN__' value='0b3ceb4e1460f961fe0d39a94e91c1f0'/></form>
    </body>
    </html>
    <script type="text/javascript">
    ...
    <script>
        ...
        $('.btn-save').click(function () {
            ...
            $.post("<?php echo u('type/add')?>",data,function (res) {
                if(res.valid){
                    layer.alert('添加成功',{
                        title: '提示框',
                        icon:1,
