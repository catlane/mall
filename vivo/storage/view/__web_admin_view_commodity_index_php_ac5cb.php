    ...
    <div class="clearfix">
        <div class="admin_info_style">
            <div class="border clearfix">
               <span class="l_f">
                    <a href="<?php echo u('commodity/add')?>" title="添加类型" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
               </span>
                <span class="r_f">共：<b><?php echo count($data)?></b>件商品</span>
            </div>
                    ...
                    <table class="table table-border table-bordered table-bg table-hover table-sort dataTable no-footer" id="sample-table" role="grid" aria-describedby="sample-table_info">
                        ...
                        <?php foreach ((array)$data as $k=>$v){?>
                            <tr role="row" class="odd">
                                ...
                                <td class="td-manage">
                                    <a title="货品列表" href="<?php echo u('goodsList/index',array('commodity_id'=>$v['commodity_id']))?>" class="btn btn-xs btn-primary"><i class="icon-list bigger-120"></i></a>
