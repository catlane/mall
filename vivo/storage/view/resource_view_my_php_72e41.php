	...
	<body>
		<div class="head-search">
			<div class="search-box">
				...
				<input type='hidden' name='__TOKEN__' value='9242646b4605d27a31f2cb347a8aaff1'/><input type='hidden' name='__TOKEN__' value='9242646b4605d27a31f2cb347a8aaff1'/></form>
				<script>
					$(function() {
        ...
        <div class="content">
            <aside class="menu-bar">
                <ul class="portrait-box">
                    <li>
                        <a href="<?php echo u('my/information')?>" title="编辑资料">
                            <img src="<?php echo __ROOT__?>/resource/hdjs/home/other/my/header_phone.jpg"/>
                        </a>
                    </li>
                    <li class="mem-name">
                        <i></i>
                        <?php echo $data["member_user_nickname"]?>
                    </li>
                    <li class="vcoin-info">
                        我的V币:
                        <a>
                ...
                <dl class="menu">
                    ...
                    <dd><a href="<?php echo u('my/order')?>">我的订单</a></dd>
                    <dd><a href="<?php echo u('my/refund')?>">退/换货</a></dd>

                    <dt>
                        <i class="icon-evaluation"></i>
                        我的账户
                    </dt>
                    <dd><a href="<?php echo u('my/information')?>">个人资料</a></dd>
                    <dd><a href="<?php echo u('my/address')?>">收货地址</a></dd>
                    <dd><a href="<?php echo u('my/favorite')?>">我的收藏</a></dd>
                </dl>
            </aside>
            <!--blade_right-->
        </div>
        ...
        <script>
            $(function () {
                $.each($(".menu dd"),function () {
                    ...
                    if($(this).find("a").html() == "<?php echo $on?>"){
                        $(this).addClass("on");
                    }
                })
            })
